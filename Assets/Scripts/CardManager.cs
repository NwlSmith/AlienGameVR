...
public class CardManager : MonoBehaviour
{
    ...
    private IEnumerator ActivateEnum()
    {
        ...
        UnityWebGLSpeechSynthesis.TTSManager.instance.Say("Incoming transmission from: " + alienName, 1);
        ...
        // Maybe change voice?
        UnityWebGLSpeechSynthesis.TTSManager.instance.Say(cardInfo.infoText, 1);
